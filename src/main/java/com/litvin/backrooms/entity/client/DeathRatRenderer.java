...
import com.litvin.backrooms.entity.client.DeathRatModel;
...
extends MobRenderer<DeathRatEntity, DeathRatModel<DeathRatEntity>> {
    public DeathRatRenderer(EntityRendererProvider.Context pContext) {
        super(pContext, new DeathRatModel(pContext.bakeLayer(com.litvin.backrooms.init.EntityInit.DEATH_RAT_LAYER)), 0.2f);
    }
